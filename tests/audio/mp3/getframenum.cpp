...
extern "C" int main(int argc, char *argv[]) {
	...
	testGetFrameNum("  Unaligned 1", &mp3Init, baseHeader, sizeof(baseHeader));
	// The old pspsdk struct had an "unk2" field that was really the high half of the 64-bit
	// stream end, which this sets to 1. Say that directly now that the field is one SceOff.
	mp3Init.mp3StreamEnd = 209 | 0x100000000LL;
